...
public class TodoController {
	...
	Collection<Todo> readList() {
		Collection<Todo> searchedTodos = service.findAll();
		log.info("searchedTodos: {}", searchedTodos);
		return searchedTodos;
	}
	
	@GetMapping("/{status}")
	Collection<Todo> readListbyStatus(@PathVariable Integer status) {
